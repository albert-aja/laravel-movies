...
@section('content')
    <div class="tvshow-info border-b border-gray-800 bg-no-repeat bg-cover bg-center" style="background-image:radial-gradient(rgba(11, 23, 34, 0.8) 0%, rgba(8, 24, 39, 0.8) 35%, rgba(17, 24, 39) 100% ), url({{ $detail['backdrop_path'] }})">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row md:grid md:grid-cols-4">
            ...
            <div class="mt-3 md:ml-24 md:mt-0 md:col-start-2 md:col-span-3">
                ...
                <div class="mt-10">
                    <h4 class="text-white font-bold text-lg">Facts</h4>
                    <p class="text-gray-300 mt-4 text-justify">
                ...
                @foreach($detail['casters'] as $cast)
                    <div class="mt-8">
                        <a href="{{ route('people.show', $cast['id']) }}">
                            <img src="{{ $cast['profile_path'] }}" alt="{{ $cast['original_name'] }}" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
                        <div class="mt-2">
                    ...
                    @foreach ($detail['images'] as $image)
                        <div class="mt-8">
                            <a
                                ...
                                href="#"
                            >
                                <img src="{{ config('services.tmdb.img').$image['file_path'] }}" alt="{{ $detail['name'] }}" class="hover:opacity-75 transition ease-in-out duration-150">
                            </a>
                        </div>
                    @endforeach
                </div>
